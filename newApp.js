    ...
    var lastScrollTop = 0;
     ...
     // if (scrollPosition >= lastScrollTop){
         ...
         if(scrollPosition>1.5*windowHeight && scrollPosition<2*windowHeight) {
           cloudParticles[Math.floor((scrollPosition-(windowHeight*1.5))/(windowHeight/2)z*40)].material.opacity=.2
           
           console.log(Math.floor((scrollPosition-(windowHeight*1.5))/(windowHeight/2)z*40));
