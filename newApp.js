...
$(() => {
  ...
  let scene, camera, renderer, blueLight, currentCloudNum, BlueLightPower, greenLightPower, cloud, cloud2, greenLight, purpleLight
  ...
  greenLight.position.set(200,500,-100);
